...
export const instructions = {
  ...
  step2: {
    ...
    content: `
      ...
      <p class="warning">Всегда указывайте не более <i>n</i> переменных!</p>
    `
  },
  step3: {
  ...
  step4: {
    ...
    content: `
      ...
      При отсутствии значения будет использоваться "бесконечность", равная ${CONST.INFINITY.toExponential().toUpperCase()}</p>
    `
  },
  step5: {
